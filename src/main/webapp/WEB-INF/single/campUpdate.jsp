...
<h2   id="center">캠핑장 수정</h2>
				<div class="form-group">
					...
					<label>캠핑장이름</label> 
					<input type="text" class="form-control" name="campname" value="${c.campname}" maxlength="50"> 
					<label>캠핑장주소</label>
					<input type="text" class="form-control" name="campaddr" value="${c.campaddr}" maxlength="100"> 
					<label>객실타입</label> 
					<input type="text" class="form-control"	name="room" value="${c.room}" maxlength="25">
					<label>남은 객실</label> 
					<input type="number" class="form-control"	name="roomcnt" value="${c.roomcnt}" oninput='Maxleng(this, 7)'> 
					<label>보유 객실</label> 
					<input type="number" class="form-control"	name="roomno" value="${c.roomno}" oninput='Maxleng(this, 7)'>
					<label>요금</label> 
					<input type="number" class="form-control"	name="payidx" value="${c.payidx}" oninput='Maxleng(this, 7)'>
					<label>체크인</label>
					...
					<label>소개 글</label> 
					<input type="text" class="form-control"	name="content" value="${c.content}" maxlength="4500">
		</div>
		<div class="form-group">
			<label>캠핑장 사진</label> 

...
<h2   id="center">캠프 생성</h2>
				<div class="form-group">
					<label>캠핑장이름</label> 
					<input type="text" class="form-control" name="campname" maxlength="50"> 
					<label>캠핑장주소</label>
					<input type="text" class="form-control" name="campaddr" maxlength="100"> 
					<label>객실타입</label> 
					<input type="text" class="form-control"	name="room" maxlength="25">
					<label>남은 객실</label> 
					<input type="number" class="form-control"	name="roomcnt" oninput='Maxleng(this, 7)'> 
					<label>보유 객실</label> 
					<input type="number" class="form-control"	name="roomno" oninput='Maxleng(this, 7)'>
					<label>요금</label> 
					<input type="number" class="form-control"	name="payidx" oninput='Maxleng(this, 7)'>
					<label>체크인</label> 
					...
					<label>소개 글</label> 
					<input type="text" class="form-control"	name="content" maxlength="4500">
		</div>
		<div class="form-group">
			<label>캠핑장 사진</label> 
